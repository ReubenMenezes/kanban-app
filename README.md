This is a Kanban app I made using Claude Code. All the FOSS tools I saw were either too complicated to install for non-tech inclined people, or not available for my OS. I don't want to pay for Kanban software, and I'm sure others don't either, so I vibecoded this. 

# List of Current Features

- Create New Projects
- Create Custom Priority Lists (in addition to the defaults of Low, Medium, and High)
- Import and Export your Data as a JSON file
- Standard Kanban Features (Draft and Drop, Delete, Create New Cards and Boards, etc etc
